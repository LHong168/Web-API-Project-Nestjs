    ...
    <div className="relative grid min-h-[80vh] place-items-center px-6 lg:px-8">
      <div className="flex flex-col space-y-6 text-center">
        ...
        <Button size="lg" asChild>
          <Link
            href="/"
            className="bg-darkBlue hover:border-primary-600 hover:bg-primary-600 mx-auto w-fit rounded-md px-5 py-3 font-sans text-base font-bold text-white duration-150 lg:px-6 lg:py-4"
          >
            Go back home
